...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/sliders */ "./js/modules/sliders.js");
/* harmony import */ var _modules_side_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/side-menu */ "./js/modules/side-menu.js");
/* harmony import */ var _modules_product_card_options__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/product-card-options */ "./js/modules/product-card-options.js");



window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_0__["initSliders"])();
  Object(_modules_side_menu__WEBPACK_IMPORTED_MODULE_1__["sideMenu"])();
  Object(_modules_product_card_options__WEBPACK_IMPORTED_MODULE_2__["productCardoptions"])();
});
...
/*!********************************************!*\
  !*** ./js/modules/product-card-options.js ***!
  \********************************************/
/*! exports provided: productCardoptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "productCardoptions", function() { return productCardoptions; });
var productCards = document.querySelectorAll('[data-produt-card]');
var productCardoptions = function productCardoptions() {
  var MAX_PREVIEWS = 7;

  // меняет картинку по клику на превью
  productCards[0] && productCards.forEach(function (card) {
    var cardImg = card.querySelector('[data-product-card-img]');
    var previews = card.querySelectorAll('[data-choice]');
    var showAllButton = card.querySelector('[data-show-all-preview]');
    ...
    previews.forEach(function (preview, i) {
      ...
      if (previews.length > MAX_PREVIEWS && i > 5) {
        ...
        showAllButton.addEventListener('click', function () {
          previews.forEach(function (previewItem) {
            return previewItem.classList.remove('hidden');
          });
          showAllButton.remove();
        });
      }
      preview.addEventListener('click', function () {
        var dataValues = JSON.parse(preview.dataset.choice);
        cardImg.src = dataValues.imgLink;
        previews.forEach(function (previewImg) {
          return previewImg.classList.remove('active');
        });
...
var burgerSideMenu = document.querySelector('[data-burger-side-menu]');
var burgerHeader = document.querySelector('[data-burger-header]');
var searchButton = document.querySelector('[data-search-side-menu]');
var searchInput = searchButton.querySelector('[data-search-side-menu-input]');
var navMenu = document.querySelector('[data-side-menu]');
...
var sideMenu = function sideMenu() {
  if (burgerSideMenu && searchInput) {
    ...
    document.body.clientWidth > 768 && searchButton.addEventListener('click', function () {
      if (!isOpen) {
        openMenu();
        searchInput.focus();
      }
...
var initSliders = function initSliders() {
  var singleSlider = document.querySelector('[data-single-slide-slider]');
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](singleSlider, {
  ...
  var popularSlider = document.querySelector('[data-popular-slider]');
